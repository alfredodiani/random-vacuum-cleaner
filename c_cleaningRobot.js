...
function renderAgentAction(diagram, action) {
    let actionLabel = {null: 'Waiting', 'SUCK': 'Vacuuming', 'UPLEFT': 'Going up-left', 'UPRIGHT': 'Going up-right', 
	'DOWNLEFT': 'Going down-left', 'DOWNRIGHT': 'Going down-right'}[action];		//alterar ação de posições
